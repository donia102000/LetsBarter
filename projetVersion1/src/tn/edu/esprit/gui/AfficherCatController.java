...
//    @FXML
//    void findtitle(ActionEvent event) { 
//      ServiceCategorie ca = new ServiceCategorie();  
//        String nomCategorie  = ca.findByTitle(lettre.getText());
//    ServiceCategorie h = new ServiceCategorie();
//     List<Categorie> result = h.findByTitle(nomCategorie);
