...
public class ListeAnnonceControllerController implements Initializable {
 ...
 @FXML
  ...
  @FXML
    ...
    @FXML
    private Button annulerReservationBtn;
    @FXML
 ...
 //   Text text3=new Text(item.getSouscategorie());
   ...
   Text text4=new Text(item.getTel());
    text4.setStyle("-fx-font-weight: bold; -fx-fill:  #8B4513;"); // Définir un style pour le Text
         text4.setFont(Font.font("Arial", FontWeight.BOLD, 20)); 
            VBox vbox = new VBox(text1,imageView,text,text4);
  ...
  likeIcon.setOnMouseClicked(event -> {
       ...
       Alert alert = new Alert(Alert.AlertType.INFORMATION);
            alert.setTitle("like  ");
            alert.setHeaderText(null);
                alert.setContentText("DisLike ajouté !!");
            alert.showAndWait();
 ...
 //          rechercherAnnonce(newValue);
   //    });
    ...
    Parent root = FXMLLoader.load(getClass().getResource("../gui/AjouterAnnonce.fxml"));
                        ...
                        primaryStage.show();}
               public void switchToListmodif(ActionEvent event) throws IOException{
    Parent root = FXMLLoader.load(getClass().getResource("../gui/ListeAnnonceController_1.fxml"));
                        Stage primaryStage = (Stage)((Node)event.getSource()).getScene().getWindow();
                        Scene scene = new Scene(root);
                        primaryStage.setScene(scene);
                        primaryStage.show();}
               public void switchToReserverEveClient(ActionEvent event) throws IOException{
    Parent root = FXMLLoader.load(getClass().getResource("../gui/AjouterReservClient.fxml"));
                        Stage primaryStage = (Stage)((Node)event.getSource()).getScene().getWindow();
                        Scene scene = new Scene(root);
                        primaryStage.setScene(scene);
                        primaryStage.show();}
               public void switchToAnnulerReserv(ActionEvent event) throws IOException{
